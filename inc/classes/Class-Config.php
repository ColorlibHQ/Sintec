 ...
 */
	...
	final class Sintec{
		...
		private function setup(){
			...
			$enqueu = new sintec_Enqueue();
			$enqueu->scripts = $this->enqueue() ;
			$enqueu->sintec_scripts_enqueue_init() ;

		}
		// Theme Support
		public function support(){
			// content width
	        $GLOBALS['content_width'] = apply_filters( 'sintec_content_width', 751 );

	        
	        // text domain for translation.
	        load_theme_textdomain( 'sintec', SINTEC_DIR_PATH . '/languages' );
			...
			add_image_size( 'sintec_widget_post_thumb', 70, 70, true );
	        ...
	        register_nav_menus( array(
	            'primary-menu'   => esc_html__( 'Primary Menu', 'sintec' ),
	            'social-menu'    => esc_html__( 'Social Menu', 'sintec' ),
	        ) );
		...
		private function enqueue(){
			...
			$cssPath = SINTEC_DIR_CSS_URI;
			$jsPath  = SINTEC_DIR_JS_URI;
			...
			$scripts = array(
				...
				'scripts' => array(
					...
					array(
						...
						'file' 			=> $jsPath.'main.js',
						'dependency' 	=> array( 'masonry', 'sintec-ui-js' ),
						'version' 		=> $this->sintec_version . '-s2',
						'in_footer' 	=> true
					),
		...
		private function google_font(){
			 ...
			 */
			if ( 'off' !== _x( 'on', 'Google font: on or off', 'sintec' ) ) {
		...
		private function customizer_init(){
			...
			// Instantiate sintec theme customizer
			$sintec_theme_customizer = new sintec_theme_customizer();
		}
	} // End Sintec Class
